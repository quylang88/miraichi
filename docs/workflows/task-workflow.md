...
5. **Large Boundary Verification**: Run integration and endpoint E2E only after a large feature boundary is complete, such as one full production tab, a crawler adapter, or an endpoint-backed capability.
