...
3. Deploy to staging only if staging targets are configured. Phase 5.11 uses Railway project `miraichi-staging` and service `miraichi-web-staging` for web/PWA staging.
