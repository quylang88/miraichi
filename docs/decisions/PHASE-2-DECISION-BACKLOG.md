...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| PH2-ADR-0003 | ADR-0003 Product Boundary | Accepted / Resolved | Phase 2 (Early Planning Gateway) | Phase 2 (Scaffolding Code) | Project Owner | Option B approved on 2026-06-23. Web router and API stubs will include read-only bet history placeholders. |
| PH2-DEC-001 | Storage Responsibility & Database | Deferred | Phase 2 (Mid-Planning) | Phase 3 (Data Ingestion) | Architect & Backend Agents | Evaluate storage options and define non-production fixture/mock data boundaries. Do not create production schemas until the related ADR is accepted. |
...
| PH2-DEC-004 | Local/Dev Env Assumptions | Accepted / Resolved | Phase 2 (Early Planning) | Phase 2 (Scaffolding Code) | Architect Agent | pnpm workspaces approved as monorepo manager on 2026-06-23 (ADR-0012). |
...
* **Status**: None. Both initial Phase 2 planning gate decisions (ADR-0003 and ADR-0012) are accepted. Phase 2 App Skeleton scaffolding code may now commence.
