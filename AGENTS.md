...
- When closing, reviewing, or handing off a phase, all agents must use [.agent/skills/miraichi-phase-transition-recommendation/SKILL.md](file:///c:/CODE/miraichi/.agent/skills/miraichi-phase-transition-recommendation/SKILL.md) to recommend the next phase and owner questions.
